...
public class AppTests extends TestBase {
    ...
    @DisplayName("test")
    void generatedTest() {
        step("Open 'https://news.liza.center'", () -> {
            // todo
        });
    }
    ...
    void titleTest() {
        step("Open url 'https://news.liza.center'", () ->
            open("https://news.liza.center"));

        step("Page title should have text 'Центр Елизаветы Глинки'", () -> {
            String expectedTitle = "Центр Елизаветы Глинки";
